...
def get_date_appearance(appearance):
    ...
    return ' uib-datepicker-popup="' + date_format + '"'
            ...
            if field_bind['constraint'].startswith('regex'):
                ...
                if root == 'root':
                    ...
                    if field_type == 'repeat':
                        ...
                        selected_instance = 'vms.model.' + field_name
                change_part = ' ng-change="parseCustomConstraints(' + selected_instance + ',\'' + str(field_bind[
                                                                                                          'constraint']) + '\', \'' + root + '\', -1, \'' + field_name + '\',\'' + constraint_msg + '\')"'
